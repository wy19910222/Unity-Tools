...
namespace OggVorbis
{
    public static class VorbisPlugin
    {
            ...
            int samplesToRead = 1024)
        {
            ...
            Save(filePath, pcm, finalChannelsCount, audioClip.frequency, quality, samplesToRead);
        }
        public static void Save(
                string filePath,
                float[] pcm,
                ...
                int samplesToRead = 1024)
        {
            int returnCode = NativeBridge.WriteAllPcmDataToFile(filePath, pcm, pcm.Length, channels, frequency, quality, samplesToRead);
